...
namespace work_ad
{
    ...
    public class cAD
    {
        ...
        public static string sDomainDefault = "dc.vol35.lan";//куда подключаемся по умолчанию
        public static string sDomain = "vol35.lan";//куда подключаемся
                                                     //    readonly static string sDefaultOU = "OU=users,OU=uns,DC=contoso,DC=com";
        public static string sDefaultRootOU = "DC=vol35,DC=lan";//где ищем по умолчанию
        public static string sServiceUser = "Администратор";//пользователь от кого делаем
        public static string sServicePassword = "Admin2021";
